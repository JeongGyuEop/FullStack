...
INSERT INTO member (username, password, name, join_date, age, address, email, phone, mobile)
VALUES
('admin4', '1234', '이순신', '2024-10-28', 25, '47727 부산 동래구 중앙대로 1393 부산 동래구 온천동 502-3 더 조은 (온천동) 참고', 'admin@test.com', '051231234', '01012341234'),
('gildong4', '2345', '홍길동', '2024-10-31', 27, '48099 부산 해운대구 달맞이길 30 부산 해운대구 중동 182999층 (중동, 엘시티)', 'gildong@example.com', '0517891234', '01077778888'),
('younghee', '4567', '김영희', '2024-11-05', 23, '12345 서울 강남구 테헤란로 20 서울 강남구 삼성동 501층 (삼성동, 코엑스)', 'younghee@example.com', '0212345678', '01098765432'),
('cheolsu', '6789', '김철수', '2024-11-08', 30, '54321 인천 남동구 경인로 120 인천 남동구 구월동 10층 (구월동, 롯데타워)', 'cheolsu@example.com', '0324567890', '01011223344'),
('jiho', '7890', '박지호', '2024-11-10', 28, '67890 대전 서구 대덕대로 99 대전 서구 둔산동 202호 (둔산동, 시티빌딩)', 'jiho@example.com', '0421234567', '01022334455');
