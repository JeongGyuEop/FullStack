...
class 취객 {
	...
	// 업캐스팅 후 부모클래스 자료형의 참조변수(매개변수)로
	// 여러 자식해장국객체들 주소를전달받을 수 있도록 매개변수는 하나만 작성해서 만들자
	...
	// --------------------- 안좋은 예 ------------------------------------------
//	// 취객이 해장국 집에 들어가서 뼈다귀 해장국 그리고 콩나물 해장국을
//	// 모두 시켜 간을 맞추는 행동을 위해 메소드 2개 추가
...
public class Test2 {
	...
	// 부모클래스 참조변수  = 자식객체 생성;
		...
		취객1.해장국간맞추기(해장국한그릇); // "뼈다귀해장국에는 들깨가루 넣기"
//		해장국한그릇.뼈추가하기(); // 부모클래스 참조변수로 접근 불가능 -> 업캐스팅의 단점 때문
		...
		// 업캐스팅
		해장국한그릇 = new 콩나물해장국();
		취객1.해장국간맞추기(해장국한그릇); // "콩나물해장국에는 고추가루 넣기"
